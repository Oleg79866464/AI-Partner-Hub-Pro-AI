...
const categoryLabels: Record<string, { title: string; description: string; keywords: string[] }> = {
  'generatsiya-teksta': {
    ...
    description:
      'Лучшие AI-инструменты для генерации текста, копирайтинга, email-рассылок, лендингов и контент-планов для маркетологов и создателей контента. Подходит для SEO-статей, лид-магнитов, прогревов и продающих воронок.',
    keywords: ['ИИ для копирайтинга', 'нейросети для текста', 'генератор текста', 'маркетинговые тексты', 'AI для лендингов'],
  },
  seo: {
    title: 'SEO',
    description:
      'AI-инструменты для SEO: оптимизация статей, семантика, кластеризация, SERP-анализ и рост органического трафика. Подборка для тех, кто продвигает сайты, блоги и landing pages в Яндексе и Google.',
    keywords: ['инструменты для SEO', 'нейросети для SEO', 'семантическое ядро', 'контент для поиска', 'AI для Яндекса'],
  },
  video: {
    title: 'Видео',
    description:
      'Нейросети для видео: нарезки, shorts, reels, подкасты, монтаж и repurposing контента для соцсетей и рекламы. Используйте для быстрого производства креативов и роста охватов без большой продакшн-команды.',
    keywords: ['AI для видео', 'нейросети для reels', 'инструменты для видео', 'видео для SMM', 'генератор shorts'],
  },
  izobrazheniya: {
    title: 'Изображения',
    description:
      'AI-инструменты для генерации изображений, креативов, баннеров, обложек и визуалов для брендов и рекламных кампаний. Подходит для performance-креативов, соцсетей и быстрой проверки гипотез.',
    keywords: ['генератор изображений', 'нейросети для баннеров', 'AI для дизайна', 'визуалы для рекламы', 'креативы для таргета'],
  },
  assistenty: {
    title: 'Ассистенты',
    description:
      'Универсальные AI-ассистенты для стратегий, исследований, аналитики, идей и автоматизации рабочих задач маркетолога. Помогают быстрее запускать кампании, собирать инсайты и масштабировать контент-производство.',
