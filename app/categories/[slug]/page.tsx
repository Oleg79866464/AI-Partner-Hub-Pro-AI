...
const categoryLabels: Record<string, { title: string; description: string; keywords: string[] }> = {
  'generatsiya-teksta': {
    ...
    description:
      'Лучшие AI-инструменты для генерации текста, копирайтинга, email-рассылок, лендингов и контент-планов для маркетологов и создателей контента.',
    keywords: ['ИИ для копирайтинга', 'нейросети для текста', 'генератор текста', 'маркетинговые тексты'],
  },
  seo: {
    title: 'SEO',
    description:
      'AI-инструменты для SEO: оптимизация статей, семантика, кластеризация, SERP-анализ и рост органического трафика.',
    keywords: ['инструменты для SEO', 'нейросети для SEO', 'семантическое ядро', 'контент для поиска'],
  },
  video: {
    title: 'Видео',
    description:
      'Нейросети для видео: нарезки, shorts, reels, подкасты, монтаж и repurposing контента для соцсетей и рекламы.',
    keywords: ['AI для видео', 'нейросети для reels', 'инструменты для видео', 'видео для SMM'],
  },
  izobrazheniya: {
    title: 'Изображения',
    description:
      'AI-инструменты для генерации изображений, креативов, баннеров, обложек и визуалов для брендов и рекламных кампаний.',
    keywords: ['генератор изображений', 'нейросети для баннеров', 'AI для дизайна', 'визуалы для рекламы'],
  },
  assistenty: {
    title: 'Ассистенты',
    description:
      'Универсальные AI-ассистенты для стратегий, исследований, аналитики, идей и автоматизации рабочих задач маркетолога.',
    keywords: ['AI ассистент', 'нейросети для маркетолога', 'чат-бот для работы', 'assistant AI'],
  },
};
...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  const title = `${info.title} для маркетинга и контента`;
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_24px_80px_-30px_rgba(15,23,42,0.3)] lg:p-10">
          <div className="max-w-4xl">
            ...
            <h1 className="mt-4 text-4xl font-black tracking-tight sm:text-5xl">{info.title} — лучшие AI-инструменты для маркетинга</h1>
